...
export declare function serializeToFile<K, V>(filePath: string, map: Map<K, V>): void;

export declare function deserialize<K, V>(json: string): Map<K, V>;
...
export declare function toMaps<T, TKey>(key: (target: T) => TKey, targets: T[])
    : Map<TKey, Map<string, any>>;
